...
export const pillars: PillarCard[] = [
  {
    ...
    title: 'The Invented Gap in Daniel 9',
    paragraphs: [
  ...
  {
    num: '02',
    label: 'Hermeneutical Integrity',
    title: 'Day-Year Principle — Explicit, Not Assumed',
    paragraphs: [
  ...
  {
    num: '03',
    label: 'The Most Damaging Problem',
    title: 'A Rebuilt Temple Denies Calvary',
    paragraphs: [
  ...
  },
  {
    ...
    title: "Futurism's Jesuit Origins",
    paragraphs: [
  ...
  },
  {
    ...
    title: 'The Rapture — No Text, No Precedent',
    paragraphs: [
  ...
  {
    num: '06',
    label: 'Prophetic Coherence',
    title: 'The 1,260 Years — Six Convergent Texts',
    paragraphs: [
...
export const futuristWeaknesses = [
  'The 70th week gap has no textual warrant — pure eisegesis',
  'Requires a rebuilt Temple that theologically contradicts Hebrews 7–10',
  'The Rapture as a separate event is not explicitly taught anywhere',
  'Hermeneutic originated with Jesuit Ribera (1590) to protect Rome',
  'No historical verification for any prophetic anchor',
  'Renders 2,000 years of church history prophetically meaningless',
  'Pre-trib Rapture invented by Darby c.1830 — no patristic support',
...
export const sdaStrengths = [
  ...
  '70 weeks fulfilled in Christ\'s ministry — no gap required',
  'Heavenly sanctuary (Heb 8–9) anchors Dan 8:14 without a rebuilt Temple',
  '1,260 years verified by 538–1798 AD history at six text-points',
  'Dominant Reformation interpretive method for 300+ years',
  'Second Coming is one visible event (Rev 1:7 — "every eye shall see")',
  'Millennium in heaven = consistent with death as sleep, earth desolate',
];
