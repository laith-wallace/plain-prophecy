...
export default function CompareClient() {
  ...
  useEffect(() => {
    ...
    const text = encodeURIComponent(
      "Futurism vs Historicism — a rigorous evidential comparison"
    );
    ...
    <>
      ...
      <div className="compare-wrapper">
        ...
        <div style={{ textAlign: "center", borderBottom: "3px double var(--ink)", paddingBottom: "2rem", marginBottom: "3rem" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
            Evangelical Futurism (Dispensationalism)
            <span style={{ fontSize: "0.6em", fontWeight: 400, fontStyle: "italic", color: "var(--neutral)", display: "block", margin: "0.25rem 0" }}>— versus —</span>
            SDA Historicism
          </h1>
        ...
        {activeTab === "timelines" && (
          <div style={{ animation: "fadeTab 0.2s ease forwards" }}>
            ...
            <div className="key-diff" style={{ marginTop: "2rem" }}>
              ...
              <p>Futurism requires a <strong>2,000+ year gap</strong> between Daniel&apos;s 69th and 70th week — an insertion with zero textual basis. Historicism reads all 70 weeks as contiguous and finds every event historically verified in the 1st century AD. The entire futurist system depends on this unproven gap.</p>
            </div>
          </div>
        )}
        ...
        {activeTab === "scoring" && (
          <div style={{ animation: "fadeTab 0.2s ease forwards" }}>
            <div className="accuracy-intro">
              <p>Each criterion is assessed on biblical evidence, internal consistency, historical verification, and hermeneutical methodology. Futurism (Dispensationalism) is assessed against classical Historicism (the SDA/Reformation position). Scores are 1–10.</p>
            </div>
            ...
            <table className="criteria-table">
              <thead>
                <tr>
                  ...
                  <th style={{ width: "34%" }}>Futurist Position</th>
                  <th style={{ width: "34%" }}>SDA Historicist Position</th>
                  <th style={{ width: "4%" }} className="score-cell">Fut.</th>
                  <th style={{ width: "4%" }} className="score-cell">SDA</th>
                </tr>
              </thead>
              <tbody>
            ...
            <div className="scoring-explainer">
              <div>
                ...
                <p className="se-subtitle">Each criterion is scored 1–10 on five independent axes, then averaged. This is not advocacy scoring — both traditions are held to the same evidentiary standard.</p>
              </div>
              ...
              <div className="se-deductions">
                <div className="se-ded-header">
                  <div className="se-eyebrow" style={{ color: "rgba(255,255,255,0.55)", marginBottom: "0.4rem" }}>Honest Assessment</div>
                  <h3 className="se-ded-title">Why Some Historicist Positions Are Not 10/10</h3>
                  <p className="se-ded-intro">The Historicist framework scores significantly higher than Futurism across every criterion — but intellectual honesty demands acknowledging where legitimate scholarly pushback exists. A 10/10 requires near-unanimous agreement among qualified exegetes.</p>
                </div>
